...
document.addEventListener("DOMContentLoaded",()=>{
    ...
    /* Obtener el formulario para modificar un posteo */
    const formModificarPosteo = document.querySelector("#form-modificar-posteo")
    ...
    posteos.forEach(posteo=>{
        ...
        botonEliminar.addEventListener("click",()=>{borrarPosteo(posteo.id)})
         ...
         botonEditar.addEventListener("click", ()=>{
            ...
            window.location.href = `editPosteo.html?id=${posteo.id}`
         })
    ...
    formModificarPosteo.addEventListener("submit", async function (evento){
